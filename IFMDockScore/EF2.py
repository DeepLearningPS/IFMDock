...
def EF_box_old():
    ...
    model = 'unimol_docking_v2' # ecdock_100conf_nodistance_step10 / current_best_mmf_ecdock / ecdock_old_copy / ecdock / ecdock_25conf / 
...
if __name__ == '__main__':
    ...
    model = 'bingnetv2_EcDock_sample_5conf_dir' # ecdock_100conf_nodistance_step10 / current_best_mmf_ecdock / ecdock_old_copy / ecdock / ecdock_25conf / 
                #mmf_ecdock / current_best_mmf_ecdock/ ecdock_old_copy / glide / carsidock / unimol_docking_v2 / karmadock / vina
    # rtm没问题，glide有问题，两种方法结果不一致
