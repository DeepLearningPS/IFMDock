...
class Equi_Consistency_Model_Parallel:
    ...
    def Load(self,modelname,loadtype='Perepoch'):
        ...
        with tempfile.TemporaryDirectory() as dirpath:
            ...
            elif loadtype=='Perepoch':  #默认加载的是这个，或许我们应该加载minloss或者每个几个epoch生成一些构象，根据评估指标来保存最佳模型，并加载
    ...
    def IC_Loss(self,pred,target,zmats,gmasks):
        ...
        ##print('zmats.shape:', zmats.shape) #zmats.shape: torch.Size([1024, 9, 5]),zmats不是维度[*;*;4]? 怎么变成[*;*;5]? 不过最后一列并没有使用
