...
class GPARMAS:
    def __init__(self):
        ...
        self.num_degrees=2
        self.depth=6
        self.consistency_training_steps=5 #注意修改, 可以与self.final_timesteps一致
        ...
        self.cross_loss = 1 #在没有探明谐振子和力场之间的权重前，先使用力场. 目前1最佳,甚至更小
        self.force_loss = 1 #力场权重

        self.sample_batch_size = 2 # #扩散的时候，不同的扩散步骤对不同的分子作用不一样，不一样越大越好
        ...
        self.use_distance   = True #是否使用距离矩阵，默认是True
        
        self.data_type = 'CrossDocked2020' #数据集类型，是CrossDocked2020还是DEKOIS2.0或者VSDS_DTEBV-D(虚拟筛选), BindingNetv2_High, 
