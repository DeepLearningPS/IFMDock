...
class Equiformer(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        reversible = True,                 # turns on reversible networks, to scale depth without incurring depth times memory cost
        ...
        **kwargs
        ...
        self.token_emb =  nn.Sequential(
            nn.Linear(num_tokens, type0_feat_dim*4),
            nn.SiLU(),
        ...
        self.edge_emb=nn.Sequential(
            nn.Linear(num_edge_tokens, edge_dim*4),
            nn.SiLU(),
