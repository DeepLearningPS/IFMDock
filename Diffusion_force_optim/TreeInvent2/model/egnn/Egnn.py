...
class GlobalLinearAttention(nn.Module):
    ...
    def forward(self, x, queries, mask = None):
        #print ('ATT',x.shape,queries.shape)
...
class EGNN(nn.Module):
    ...
    def forward(self, feats,  coors, edges, mask = None, adj_mat = None):
        ...
        #print (rel_coors.shape,rel_coors)
        ...
        #print (feats_i.shape,feats_j.shape,rel_dist.shape)
...
class EGNN_Network(nn.Module):
        ...
        **kwargs
        ...
        for ind in range(depth):
            ...
            self.layers.append(nn.ModuleList([
                ...
                EGNN(dim = dim, edge_dim = edge_dim, norm_feats = True, **kwargs),
            ]))
    ...
    def forward(
        ...
        for global_attn, egnn in self.layers:
            ...
            feats, coors = egnn(feats, coors, edges = edges, mask = mask)
