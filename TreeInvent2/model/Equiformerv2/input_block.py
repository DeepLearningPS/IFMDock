...
class EdgeDegreeEmbedding(torch.nn.Module):
    ...
    def forward(
        ...
        if self.use_atom_edge_embedding:
            source_element = feats[edge_index[0]]  # Source atom atomic number
            target_element = feats[edge_index[1]]  # Target atom atomic number
        ...
        x_edge_embedding._reduce_edge(edge_index[1], feats.shape[0])
