...
def single_refine(
    ...
    output_ligand_path = os.path.join(pathname, 'clash_fix_optimize_' + filename) #优化
    #保存sdf
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="Number of trials for confgen + 6t superimposition. Keeps the lowest RMSD") #superimposition叠加
    parser.add_argument(
