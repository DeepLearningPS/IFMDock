...
def main(args) -> None:
    ...
    # 如果是第一次运行，没保存模型，则加载之前的3个预训练模型，如果保存过模型，则加载最新的模型，是3个模型的合并版本
...
def train(
    ...
    #print('len(progress):', len(itr)) # 1912个批量 = 1912 * 10 = 19120个样本
...
def cli_main(
    ...
    args = options.parse_args_and_arch(parser, modify_parser=modify_parser) #合并参数，并修改，以modify_parser的主
